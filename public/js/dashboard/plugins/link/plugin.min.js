    ...
    const G = e => s(e) && "a" === e.nodeName.toLowerCase(),
        ...
        ie = (e, t, n) => {
            const o = e.selection.getNode(),
                ...
                l.class = l.class ? l.class + " link" : "link";
            ...
            e.hasPlugin("rtc", !0) ? e.execCommand("unlink") : (e => {
                e.undoManager.transact((() => {
                    ...
                    le(t) ? ue(e, t) : (e => {
                        ...
                        l && r.setStartBefore(l), i && r.setEndAfter(i), n.setRng(r), e.execCommand("unlink"), n.moveToBookmark(o)
                    })(e), e.focus()
                }))
            })(e)
        },
                    ...
                    return {
                        ...
                        body: {
                            ...
                            items: p([
                                ...
                                }], o, r, x([i.anchor.map(K("anchor", "Anchors")), i.rels.map(K("rel", "Rel")), i.targets.map(K("target", "Open link in...")), i.link.map(K("link", "Link list")), i.classes.map(K("linkClass", "Class"))])
                            ])
                        },
                        buttons: [{
                            type: "cancel",
