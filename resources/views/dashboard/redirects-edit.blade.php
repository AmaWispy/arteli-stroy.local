<x-dashboard.layout>
    <form class="w-100 mx-auto" action="/update-redirect" method="post">
        @csrf
        ...
        <div class="mb-5">
            ...
            <input type="text" id="from" name="from"
                ...
                placeholder="/from" value="{{ $redirect->from }}" />
            @error('from')
        ...
        <div class="mb-5">
            ...
            <input type="text" id="to" name="to"
                ...
                placeholder="/to" value="{{ $redirect->to }}" />
            @error('to')
                <p class="text-red-700">{{ $message }}</p>
            @enderror
        </div>
    ...
    <div class="w-100 absolute top-20 right-4">
        <button id="delete-article" type="button"
            class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Удалить</button>
    </div>
    ...
    <div id="confirm-deletion" tabindex="-1"
        ...
        <div id="modal" class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5 text-center" method="post" action="/delete-redirect">
                    @csrf
