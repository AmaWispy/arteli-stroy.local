        ...
        <div class="content-fluid">
            ...
            <div class="servicePage-block">
                ...
                @foreach ($articles as $article)
                    <a class="article-previews" href="/{{ $article->link }}">
                        <div class="servicePage-block__item">
                            <img src="/{{ $article->image }}" alt="{{ $article->short_title }}"
                                class="servicePage-block__item-img">
                            <span class="servicePage-block__item-text">{{ $article->short_title }}</span>
                        </div>
                    </a>
                @endforeach
