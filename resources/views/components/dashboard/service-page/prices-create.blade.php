    ...
    <div class="grid grid-cols-[repeat(3,_1fr)] gap-4">
        <div>
            ...
            <div class="mb-5 prices__list">
                <div class="mb-5 flex justify-between prices__item" data-index=0>
                    <div class="w-[80%]">
                        <label for="price_list_1" class="block mb-2 text-sm font-medium text-gray-900 ">Активный элемент
                            списка</label>
        ...
        <div>
            ...
            <div class="mb-5 prices__list">
                <div class="mb-5 flex justify-between prices__item" data-index=0>
                    <div class="w-[80%]">
                        <label for="price_list_2" class="block mb-2 text-sm font-medium text-gray-900 ">Активный
                            элемент списка</label>
        ...
        <div>
            ...
            <div class="mb-5 prices__list">
                <div class="mb-5 flex justify-between prices__item" data-index=0>
                    <div class="w-[80%] ">
                        <label for="price_list_3" class="block mb-2 text-sm font-medium text-gray-900 ">Активный
                            элемент списка</label>
